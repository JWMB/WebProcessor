...
namespace TrainingApi.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public AccountsController(OldDbRaw oldDb, ITrainingPlanRepository trainingPlanRepository, ITrainingRepository trainingRepository, MnemoJapanese mnemoJapanese, UsernameHashing usernameHashing,
        ...
        [HttpPost]
        public async Task<string> Post(AccountCreateDTO dto)
        {
        ...
        [HttpPut]
        public async Task<string> Put(AccountCreateDTO dto)
        {
            await Task.Delay(1);
            return "";
        }
