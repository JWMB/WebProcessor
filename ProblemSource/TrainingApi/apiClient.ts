...
export class RelayClient {
    ...
    getSyncUrls(uuid: string | undefined): Promise<FileResponse | null> {
        ...
        if (uuid === null)
            throw new globalThis.Error("The parameter 'uuid' cannot be null.");
...
export class TestingClient {
    ...
    callPredictor(): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/api/Testing/predict";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCallPredictor(_response);
        });
    }

    protected processCallPredictor(response: Response): Promise<FileResponse | null> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
...
export class TrainingsClient {
    ...
    postGroup(dto: TrainingCreateDto, groupName: string | undefined, numTrainings: number | undefined): Promise<string[]> {
        ...
        if (numTrainings === null)
            throw new globalThis.Error("The parameter 'numTrainings' cannot be null.");
    ...
    getTemplates(returnOnlyDefaultTemplate: boolean | undefined): Promise<TrainingTemplateDto[]> {
        let url_ = this.baseUrl + "/api/Trainings/templates?";
        if (returnOnlyDefaultTemplate === null)
            throw new globalThis.Error("The parameter 'returnOnlyDefaultTemplate' cannot be null.");
        else if (returnOnlyDefaultTemplate !== undefined)
            url_ += "returnOnlyDefaultTemplate=" + encodeURIComponent("" + returnOnlyDefaultTemplate) + "&";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getAiAnalysis(trainingId: number | undefined, templateSource: string | undefined, onlyPrompt: boolean | undefined): Promise<AnalysisDto> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetAiAnalysis(_response);
        });
    }
...
export class UsersClient {
    ...
    getTrainingUsername(id: number): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/api/Users/trainingUsername/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetTrainingUsername(_response);
        });
    }

    protected processGetTrainingUsername(response: Response): Promise<FileResponse | null> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
    ...
    getOrCreateFromApp(username: string | undefined): Promise<GetUserDto> {
        let url_ = this.baseUrl + "/api/Users/getOrCreate?";
        if (username === null)
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetOrCreateFromApp(_response);
        });
    }

    protected processGetOrCreateFromApp(response: Response): Promise<GetUserDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
